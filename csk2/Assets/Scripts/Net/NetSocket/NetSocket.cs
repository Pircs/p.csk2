    ...
    public class NetSocket
    {
        ...
        public virtual bool StartConnect(string host, uint port)
        {
            if (clientSocket != null)
            {
                ...
                {
					com.QH.QPGame.GameUtils.Logger.Net.LogWarning("socket connected already.");
                    //return true;
                }
        ...
        private void AsyncConnect(IPAddress host, uint port)
        {
            try
            {
				com.QH.QPGame.GameUtils.Logger.Net.Log("AsyncConnect:"+host+" port:"+port);
            ...
            {
				com.QH.QPGame.GameUtils.Logger.Net.LogException(exception);
            }
        }
		...
		private void getHostCallback(IAsyncResult asyncGetHost)
		{
			try
			{
				...
				com.QH.QPGame.GameUtils.Logger.Net.Log("getHostCallback.  len:" + 
                    addresses.Length + " ip:" + 
        ...
        {
			com.QH.QPGame.GameUtils.Logger.Net.Log("connectCallback");
        ...
        {
			com.QH.QPGame.GameUtils.Logger.Net.Log("OnSocketDisconnect");
        ...
        private void DispatchMsg(Packet packet)
        {
			...
			{
				com.QH.QPGame.GameUtils.Logger.Net.LogException(ex);
			}
        }
        ...
        {
			com.QH.QPGame.GameUtils.Logger.Net.Log("Close Socket. IP:"+ServerHost+" Port:"+ServerPort);
