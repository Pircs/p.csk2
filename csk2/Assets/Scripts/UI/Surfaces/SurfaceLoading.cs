...
namespace com.QH.QPGame.Lobby.Surfaces
{
	public class SurfaceLoading : Surface 
    {
	    ...
	    {
			com.QH.QPGame.GameUtils.Logger.UI.Log("begin show loading. Scene:"+scene+" Prefab:"+prefab+" Assetbundle:"+abName);
	    ...
	    private IEnumerator Load(string scene, string prefab, string abName)
	    {
	        ...
	        if (loading == null)
	        {
				com.QH.QPGame.GameUtils.Logger.UI.LogError("no match loading prefabs loaded");
	            yield break;
	        }
