...
namespace com.QH.QPGame.Lobby
{
    public class WebClientWithTimeout : WebClient
    {
        ...
        protected override WebResponse GetWebResponse(WebRequest request)
        {
            ...
            if (res != null)
            {
				com.QH.QPGame.GameUtils.Logger.Sys.Log("web response length:" + res.ContentLength);
    ...
    public class Downloader
    {
        ...
        {
			com.QH.QPGame.GameUtils.Logger.Sys.Log("add file task. Url:" + url + " SaveAs:" + saveAs + " UserData:" + userData);
        ...
        public void RunNextTask()
        {
			...
			com.QH.QPGame.GameUtils.Logger.Sys.Log("start download begin, file:" + task.Url);
            ...
            {
				com.QH.QPGame.GameUtils.Logger.Sys.LogException(e);
            }
        }
        ...
        {
            var task = args.UserState as DownloadTask;
			com.QH.QPGame.GameUtils.Logger.Sys.Log("data completed. Url:" + task.Url + " Error:" + args.Error);
        ...
        {
            var task = args.UserState as DownloadTask;
			com.QH.QPGame.GameUtils.Logger.Sys.Log("string completed. Url:" + task.Url + " Error:" + args.Error);
        ...
        {
            var task = args.UserState as DownloadTask;
			com.QH.QPGame.GameUtils.Logger.Sys.Log("file completed. Url:" + task.Url + " Error:" + args.Error);
