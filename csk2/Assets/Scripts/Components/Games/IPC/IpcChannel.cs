...
namespace com.QH.QPGame.GameCore
{
	...
	public partial class IpcService
	{
		...
		public bool CreateServer ()
		{
			...
			com.QH.QPGame.GameUtils.Logger.Sys.Log("Start IPC Thread");
		...
		public void ReceiveLoop ()
		{
			...
			if (IpcWindowHandle == IntPtr.Zero) {
				com.QH.QPGame.GameUtils.Logger.Sys.LogError("call CreateIpcModuleEx failed");
				return;
			}


			com.QH.QPGame.GameUtils.Logger.Sys.Log("call CreateIpcModuleEx finished, handle:" + IpcWindowHandle.ToString("X"));
			...
			while (mReceiveThreadRuning) {
				...
				if(mSendBufferQueue.Count != 0){
					...
					{
						com.QH.QPGame.GameUtils.Logger.Sys.LogError("send data to ipc failed|msg:" + e.Message +
						                  "|source:"+e.Source+
			    ...
			    {
					com.QH.QPGame.GameUtils.Logger.Sys.LogError("peek msg|msg:" + e.Message +
			                         "|source:" + e.Source +
			                         "|stack:" + e.StackTrace
			            );
			    }
