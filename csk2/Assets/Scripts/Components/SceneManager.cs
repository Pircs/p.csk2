    ...
    public class SceneManager : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            if (string.Compare(Application.loadedLevelName, GlobalConst.UI.UI_SCENE_MAIN, true) != 0)
            {
				...
				com.QH.QPGame.GameUtils.Logger.Sys.Log("Loading Scene:" + GlobalConst.UI.UI_SCENE_MAIN);
                Application.LoadLevel(GlobalConst.UI.UI_SCENE_MAIN);
            }
            else
            {
				com.QH.QPGame.GameUtils.Logger.Sys.Log("Loading Scene:" + GlobalConst.UI.UI_SCENE_LOGIN);
		...
		{
			com.QH.QPGame.GameUtils.Logger.Sys.Log("enter scene. Name:" + sceneName + " WithLoading:" + loadingPrefab);
